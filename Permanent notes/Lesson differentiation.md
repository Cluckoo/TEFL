...
1. grouping students with mixed ability, so that the stronger ones can help
2. grouping students BASED on ability, so that stronger students work with stronger students, and weaker students with weaker students.

Doing only no.1 may make students feel like they are being "used" as teaching tools. 

However, doing no.2 allows you to create tasks that can be adapted to be different difficulties, i.e., differentiation. E.g., 
...
- Or, create a big worksheet, and allocate groups of students to do different parts, and if some students from group A finish quickly, they can start on group B questions. 
